...
encodeFunctionData(functionFragment: 'hasDoubleVoting', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'hasMembership', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'isApprovedForAll', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'mintMembership', values: [AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'hasDoubleVoting', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'hasMembership', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'isApprovedForAll', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'mintMembership', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface CrowdMembership extends BaseContract {
    
    connect(runner?: ContractRunner | null): CrowdMembership;
    waitForDeployment(): Promise<this>;

    interface: CrowdMembershipInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    hasDoubleVoting: TypedContractMethod<
      [arg0: BigNumberish, ],
      [boolean],
      'view'
    >
    ...
    hasMembership: TypedContractMethod<
      [arg0: AddressLike, ],
      [boolean],
      'view'
    >
...
getFunction(nameOrSignature: 'getApproved'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'hasDoubleVoting'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'hasMembership'): TypedContractMethod<
      [arg0: AddressLike, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'mintMembership'): TypedContractMethod<
      [to: AddressLike, ],
      [bigint],
      'nonpayable'
    >;
